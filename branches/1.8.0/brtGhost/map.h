...
private:
	...
	uint32_t m_MapOnlyAutoWarnIfMoreThanXPlayers;// automated warns only apply if at least X players.
	vector<uint32_t> m_AutoWarnMarks;
...
public:
	...
	uint32_t GetMapOnlyAutoWarnIfMoreThanXPlayers( ) { return m_MapOnlyAutoWarnIfMoreThanXPlayers; }
