...
BYTEARRAY CBNETProtocol :: SEND_SID_GETADVLISTEX( )
{
	unsigned char MapFilter1[]	= {  0, 224, 127, 0 };
	unsigned char MapFilter2[]	= {  0,   0,   0, 0 };
	unsigned char MapFilter3[]	= {  0,   0,   0, 0 };
	unsigned char NumGames[]	= { 20,   0,   0, 0 };
...
BYTEARRAY CBNETProtocol :: SEND_SID_STARTADVEX3( bool isPatch21, unsigned char state, BYTEARRAY mapGameType, BYTEARRAY mapFlags, BYTEARRAY mapWidth, BYTEARRAY mapHeight, string gameName, string hostName, uint32_t upTime, string mapPath, BYTEARRAY mapCRC, BYTEARRAY mapSHA1, uint32_t hostCounter )
{
